...
#define CONTROL_PIN 25  // Pin que se encenderá/apagará según el comando
/*
...
/* Includes ---------------------------------------------------------------- */
#include <Comandos_de_voz_inferencing.h>
#include <PDM.h>
...
void setup()
{
    ...
    digitalWrite(CONTROL_PIN, LOW); // Asegura que inicie apagado
...
void loop()
{
 ...
 for (uint16_t i = 0; i < EI_CLASSIFIER_LABEL_COUNT; i++) {
            ...
            if (strcmp(label, "Encender") == 0 && confidence > 0.80f) {
                digitalWrite(CONTROL_PIN, HIGH);
                ei_printf(">> Comando 'encender' detectado. Pin activado.\r\n");
            }
            else if (strcmp(label, "Apagar") == 0 && confidence > 0.80f) {
                digitalWrite(CONTROL_PIN, LOW);
                ei_printf(">> Comando 'apagar' detectado. Pin desactivado.\r\n");
            }
        }
        print_results = 0;
    }
